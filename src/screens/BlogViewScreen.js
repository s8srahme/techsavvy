...
export class BlogViewScreen extends Component {
	...
	render = () => {
		const post = {
				...
				// description: `Still can't bring yourself to accept the iPhone X's notch?
				...
				description: `<p>Still can't bring yourself to accept the <a href="https://mashable.com/category/iphone-x/">iPhone X</a>'s notch?</p>
